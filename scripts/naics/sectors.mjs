...
const RAW = [
  [
    ...
    'Farms, ranches, timber operations, fisheries and support services like crop dusting and farm labor contracting.',
    'green',
  ],
  [
    '21',
    ...
    'Oil and gas wells, coal and mineral mines, quarries and the drilling and field services that keep them producing.',
    'bronze',
  ],
  [
    '22',
    'utilities',
    'Utilities',
    'Electric power generation and delivery, natural gas distribution, water systems and sewage treatment.',
    'gold',
  ],
  [
    '23',
    'construction',
    'Construction',
    'General contractors, homebuilders and specialty trades from electrical to roofing, plus heavy and civil work like roads and bridges.',
    'teal',
  ],
  [
    '31-33',
    'manufacturing',
    'Manufacturing',
    'Plants that turn materials into products: food processing, wood and metal fabrication, machinery, electronics and everything between.',
    'teal',
  ],
  [
    '42',
    'wholesale',
    'Wholesale Trade',
    'Distributors that sell goods to businesses rather than consumers, from building supplies to grocery wholesalers.',
    'bronze',
  ],
  [
    '44-45',
    'retail',
    'Retail Trade',
    'Stores and dealers that sell to the public: groceries, gas stations, auto dealers, clothing and online sellers.',
    'gold',
  ],
  [
    '48-49',
    ...
    'Trucking, air and rail carriers, transit systems, pipelines, couriers and the warehouses that hold freight between trips.',
    'teal',
  ],
  [
    '51',
    'information',
    'Information',
    'Software publishers, telecommunications, data centers and hosting, broadcasting and media production.',
    'green',
  ],
  [
    '52',
    ...
    'Banks and credit unions, lenders, investment firms, insurance carriers and agencies.',
    'green',
  ],
  [
    '53',
    ...
    'Property owners and managers, real estate agents and rental businesses from apartments to equipment yards.',
    'bronze',
  ],
  [
    '54',
    ...
    'Engineering and architecture firms, lawyers, accountants, consultants, research labs and IT services.',
    'gold',
  ],
  [
    '55',
    ...
    'Holding companies and corporate offices that oversee other establishments of the same enterprise.',
    'bronze',
  ],
  [
    '56',
    ...
    'Staffing agencies, janitorial and landscaping crews, security services, call centers and waste collection.',
    'green',
  ],
  [
    '61',
    ...
    'Schools, colleges and universities, tribal colleges, training centers and tutoring providers.',
    'gold',
  ],
  [
    '62',
    ...
    'Hospitals, clinics, dental and behavioral health practices, nursing care, child care and social services.',
    'teal',
  ],
  [
    '71',
    ...
    'Museums and cultural centers, performing arts, sports and recreation businesses, casinos without hotels among them.',
    'gold',
  ],
  [
    '72',
    ...
    'Hotels, casino hotels, RV parks, restaurants, caterers and bars.',
    'bronze',
  ],
  [
    '81',
    ...
    'Repair shops, personal care, religious and civic organizations and similar services that fit nowhere else.',
    'gold',
  ],
  [
    '92',
    ...
    'Government at every level: executive and legislative offices, courts, public safety and program administration.',
    'green',
  ],
];
