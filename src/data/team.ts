...
export const TEAM: Person[] = [
  {
    ...
    bio: [
      ...
      "Before founding Lumecon, Elijah was a Senior Research Assistant at the Federal Reserve Bank of Minneapolis, where he worked on research related to Indian Country, economic development, and public policy. His work brings together applied economics, institutional research, and data systems to help communities better understand and communicate their economic impact.",
    ],
  },
  {
    slug: 'michael-moreno',
  ...
  },
  {
    ...
    bio: [
      ...
      "Laurel previously worked as an economist at the Federal Reserve Bank of Minneapolis.",
    ],
  },
  {
    slug: 'isabella-agnes',
