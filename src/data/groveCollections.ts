 ...
 *
 * Every line here is read from the Cedar Press catalog and its dataset
 * documentation (cedar-press `src/features/grove/pressCatalog.js` and
 * `docs/datasets/*`), never written fresh for the website:
 *
 ...
 * - `access` is the shelf the collection sits on in Cedar Press, and the
 *   condition a listing carries where the documentation states one.
 *
 ...
 *
 * The marks are the Cedar Press collection icons, transcribed from
...
export const GROVE_COLLECTIONS: GroveCollection[] = [
  {
    ...
    access: 'Cedar Press. Public records; the resolution to Native entities is Cedar’s work.',
  ...
  },
  {
    ...
    access: 'Cedar Press+. Filer-reported and unaudited; totals are stated with that limit.',
  ...
  },
  {
    ...
    access: 'Cedar Press+. A listing appears only under its nation’s stated terms.',
  ...
  },
  {
    ...
    access:
      'Cedar Press+. Public records; the classification is Cedar’s work and stays reviewable.',
  ...
  },
  {
    ...
    access:
      'Cedar Press+. Unresolved ties stay unresolved; a provisional match is labeled provisional.',
