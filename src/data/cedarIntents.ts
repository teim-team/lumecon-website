...
export const INTENTS: CedarIntent[] = [
  ...
  },
  {
    ...
    answer: "Lumecon runs on a flat annual subscription, not per-study or per-geography. Local starts at $7.5K a year (covering county, state, and national), Tribal at $10K (reservation, county, state, and national). Each platform has three tiers (Sprout, Sapling, Tree) that top out at $20K for Local and $25K for Tribal, with unlimited studies. Sprout supports monthly or quarterly payment plans against a 12-month commitment, with no upcharge, so smaller orgs can align payments with their budget cycles. For comparison, the legacy stack is commonly cited at $50K to $150K per study. The full grid is on the pricing page, no demo call required. Want me to break down what each tier includes?",
    expanded: "More on pricing: Local Sprout is $7.5K, Sapling $15K, Tree $20K — geographies covered are county, state, and national. Tribal Sprout is $10K, Sapling $17.5K, Tree $25K — geographies are reservation, county, state, and national. Cedar comes with Sapling and above; on those tiers Cedar uploads and processes your data (PDFs, CSVs, and XLSX files today, with more formats expanding over time), structures it for the model, and produces branded reports built around your visual identity (your logo, colors, your own images). Cedar Grove comes with Tree — that's the harmonized-data layer that compounds across studies and the compliance-ready reporting for grants, federal submissions, and audited annual reports. Cedar Grove is not available as a standalone subscription. There's also a Toolbox add-on at +$15K when you want our team to produce the finished package directly: report, deck, executive summary, source record, assumption ledger, with three rounds of revisions and branded outputs. A separate Consultant plan is project-based: $15K flat for two projects (one project per distinct client entity), renewable as new engagements — that plan does not include Cedar, Cedar Grove, or Toolbox. Seats scale by tier (one on Sprout, up to five on Sapling, up to ten on Tree).",
  },
  {
    id: 'payment_plans',
  ...
  },
  {
    ...
    answer: "Yes, there's a Consultant plan, and it's project-based, not a subscription: $15K flat for two projects (one project per distinct client entity, no consortia), with all geographies included (reservation, county, state, national). When you finish the two, the next engagement is a fresh $15K with the next two clients — there's no auto-renewing annual line. Cedar, Cedar Grove, and the Toolbox add-on are not part of this plan, because it's built for firms producing their own deliverables for their own clients. If your volume is larger or you want to white-label, email contact@lumecon.ai and the team will scope a partner arrangement.",
    expanded: "Why the Consultant plan is shaped this way: the lower flat rate reflects a tighter constraint set than the regional plans. Two projects, one per distinct entity, single-entity projects only (no rolling several clients into one consortium engagement). The plan is project-based, not an auto-renewing annual subscription — when you finish those two projects you book the next engagement as a fresh $15K. Cedar and Cedar Grove stay inside customer subscriptions because the AI workflow and the harmonized-data layer are part of the customer's data sovereignty story, not tools to be resold. Toolbox is excluded because we don't compete with consulting firms on the writing-and-presentation side; that's the firm's value-add. What's included is the modeling engine, the data, and the geography coverage, which is what makes a Lumecon study a Lumecon study.",
  },
  {
    id: 'demo',
  ...
  /* --- Grants / consultants --- */
  {
    ...
    answer: "There's a dedicated Consultant plan for firms running studies on behalf of outside clients. It's project-based, not a subscription: $15K flat for two projects (one project per distinct client entity), renewable as a new engagement when those wrap up. All geographies (reservation, county, state, national) are included. Each project must be a single entity (no consortia), and Cedar, Cedar Grove, and the Toolbox add-on are not part of this plan. If your volume is larger, email contact@lumecon.ai with your setup and the team will scope a partner arrangement.",
