...
export const INTENTS: CedarIntent[] = [
  ...
  },
  {
    ...
    triggers: [
      ...
      'messy data', 'messy files', 'messy spreadsheets', 'unstructured data', 'different formats', 'any format', 'multiple formats', 'mixed formats', 'pdf data', 'scanned pdf', 'scanned image', 'scanned images', 'process my data', 'process our data', 'handle messy', 'clean up my data', 'clean my data', 'data cleaning', 'data wrangling',
      'handle pdfs', 'handle pdf', 'process pdf', 'process pdfs', 'cedar handle', 'cedar process', 'cedar upload', 'cedar ingest', 'upload my files', 'upload my data', 'upload pdfs', 'upload spreadsheets', 'upload payroll', 'upload audit',
    ],
    answer: "I'm Cedar, Lumecon's assistant. Inside the platform I upload and process messy data in any format (PDFs, scanned images, spreadsheets, payroll, finance, audit, planning files), structure it for the impact model, surface every assumption for your sign-off, and act as a thought partner on the write-up. The substance and local context come from you; I handle the data wrangling and the polish. Here on the site I'm a lighter version: ask me what Lumecon does, who it's for, what a study costs, or how to reach the team.",
  },
  {
    id: 'audience',
  ...
  },
  {
    ...
    triggers: [
      'what reports', 'what report', 'pdf report', 'final output', 'output look like', 'create dashboards', 'dashboard', 'export the results', 'export', 'presentations', 'public meetings', 'board materials', 'board deck', 'slide deck', 'economic impact report', 'impact report', 'annual report', 'annual impact report', 'community impact report', 'donor report', 'one pager', 'one-pager', 'executive summary', 'what format', 'deliverables', 'what do you produce', 'what does it produce', 'report do you', 'what kind of report', 'kind of reports', 'what sort of report', 'reports does it produce',
    ],
    answer: "Every study gives you a full report PDF, an editable executive summary, the underlying tables and charts, and a slide-ready deck as starting points you can edit. With Cedar (Sapling tier and above) the report comes out branded to your visual identity (your logo, colors, typography) and you can drop in your own images and photography so the deliverable reads as yours. Cedar works as a thought partner on the write-up: it suggests structure, edits, takes your feedback, and reshapes the framing for the audience you're talking to (funders see the jobs-and-investment narrative, councils see local benefit, boards see strategic context, public meetings get the plain-language version), while the substance, voice, and local context come from you. The numbers are identical across versions; only the framing changes. Who's the audience you need to win over?",
  ...
  },
  {
    ...
    answer: "Lumecon runs on a flat annual subscription, not per-study or per-geography. Local starts at $7.5K a year, Tribal at $10K. Each platform has three tiers (Sprout, Sapling, Tree) that top out at $20K for Local and $25K for Tribal, with unlimited studies across reservation, county, state, and national geographies. Sprout supports monthly or quarterly payment plans against a 12-month commitment, with no upcharge, so smaller orgs can align payments with their budget cycles. For comparison, the legacy stack is commonly cited at $50K to $150K per study. The full grid is on the pricing page, no demo call required. Want me to break down what each tier includes?",
    expanded: "More on pricing: Local Sprout is $7.5K, Sapling $15K, Tree $20K. Tribal Sprout is $10K, Sapling $17.5K, Tree $25K. Cedar comes with Sapling and above; on those tiers Cedar uploads and processes messy data in any format, structures it for the model, and produces branded reports built around your visual identity (your logo, colors, your own images). Cedar Grove comes with Tree — that's the harmonized-data layer that compounds across studies and the compliance-ready reporting for grants, federal submissions, and audited annual reports. Cedar Grove is not available as a standalone subscription. There's also a Toolbox add-on at +$15K when you want our team to produce the finished package directly: report, deck, executive summary, source record, assumption ledger, with three rounds of revisions and branded outputs. A separate Consultant plan exists for firms running studies on behalf of two distinct outside clients in a single fiscal year, at $15K flat — that plan does not include Cedar, Cedar Grove, or Toolbox. Seats scale by tier (one on Sprout, up to five on Sapling, up to ten on Tree).",
  },
  {
    id: 'payment_plans',
  ...
  },
  {
    ...
    triggers: [
      'toolbox', 'tool box', 'add on', 'add-on', 'addon', 'study add on', 'study add-on', 'study package', 'done for you', 'done-for-you', 'done for me', 'write the report', 'write my report', 'write the study', 'finished report', 'finished study', 'finished deliverable', 'branded report', 'branded deliverable', 'branded outputs', 'branded output', 'use my own images', 'my own images', 'own images', 'use our images', 'our images', 'our logo', 'our branding', 'our brand', 'press ready', 'press-ready', 'media kit', 'rounds of revision', 'rounds of revisions', 'revisions on', 'help write', 'help me write', 'help with the report', 'help with the deck', 'turn around the report', 'have your team write', 'your team write', 'your team produce',
    ],
    answer: "Toolbox is a +$15K flat-fee add-on that attaches to an active Lumecon subscription. Our team takes the outputs your platform already produces and turns them into a finished economic impact package: a full written report, presentation deck, executive summary, source record, assumption ledger, and one tailored memo or media-ready findings sheet. Every deliverable is branded to your visual identity (your logo, colors, typography, your own images and photography) so it reads as yours, not ours. Three rounds of revisions are included and the flat fee covers taxes. It's not a standalone product because the heavy lifting happens inside Lumecon; the add-on is the writing, design, and presentation polish on top.",
    expanded: "Why Toolbox is structured this way: a traditional consulting study runs $50K to $150K because the consultant is doing the data work, the modeling, the writing, and the design from scratch every time. With Lumecon, the data structuring, source record, and modeling are already done inside your subscription, so the writing-and-presentation portion is what's left, and that's what Toolbox covers at the flat $15K. The plan recommendation is Sapling or Tree for Toolbox engagements, because Cedar handles the intake and the assumption ledger that the report leans on. Note that you don't have to add Toolbox to get branded reports: Cedar inside Sapling and Tree already produces branded outputs that use your visual identity and your own images. Toolbox is the option when you want our team writing and designing the package for you. Toolbox is not available on the Consultant plan, because that plan is structured around firms producing their own deliverables for their own clients.",
  },
  {
    id: 'consultant_plan',
    ...
    triggers: [
      'consultant plan', 'consulting plan', 'plan for consultants', 'plan for consulting', 'arborist', 'arborist plan', 'arborist tier', 'is there a consultant', 'consultants plan', 'plan for me as a consultant', 'lumecon for consultants', 'for consultants', 'consulting firm', 'consulting firms', 'as a consulting firm', 'studies for clients', 'studies for my clients', 'do studies for clients', 'run studies for clients', 'on behalf of clients', 'for outside clients', 'for outside organizations',
    ],
    answer: "Yes, there's a Consultant plan at $15K a year, flat. It covers two distinct outside client entities (no consortium) in a single fiscal year, with all geographies included (reservation, county, state, national). Cedar, Cedar Grove, and the Toolbox add-on are not part of this plan, because the plan is built for firms producing their own deliverables for their own clients. If you need more than two clients a year or want to white-label, email contact@lumecon.ai and the team will scope a partner arrangement.",
    expanded: "Why the Consultant plan is shaped this way: the lower flat rate reflects a tighter constraint set than the regional plans. Two distinct entities, one fiscal year, one project per entity, single-entity projects only (no rolling several clients into one consortium engagement). Cedar and Cedar Grove stay inside customer subscriptions because the AI workflow and the harmonized-data layer are part of the customer's data sovereignty story, not tools to be resold. Toolbox is excluded because we don't compete with consulting firms on the writing-and-presentation side; that's the firm's value-add. What's included is the modeling engine, the data, and the geography coverage, which is what makes a Lumecon study a Lumecon study.",
  },
  {
    id: 'demo',
  ...
  },
  {
    ...
    triggers: [
      ...
      'ss4a', 'safe streets', 'safe streets and roads', 'bric', 'building resilient', 'nofo', 'notice of funding', 'community facilities', 'reconnect', 'nmtc', 'new markets tax credit', 'letter of support', 'national objective',
    ],
  ...
  },
  {
    ...
    answer: "Cedar Grove is what Cedar grows into across multiple studies. The data your team uploaded for the first study, the public sources it was harmonized against, the assumptions you reviewed, the geographic bridges, and the compliance-ready report templates all stay in your workspace and get reused on the next study. That means recurring submissions (annual impact reports, federal grant cycles, audited filings) don't start from a blank file — they start from a harmonized, citable base that's already passed your reviewers. We don't call it a grove just because it sounds warmer than data lake. A data lake stores information; Cedar Grove gives that information roots. Cedar Grove comes with the Tree tier and is not available as a standalone subscription. And yes, if a tree falls in the forest, would anyone hear it? If it has an impact on the economy, Lumecon will measure it.",
  },
  {
    id: 'ai_vs_chatgpt',
  ...
  /* --- Tribal --- */
  {
    ...
    answer: "Trust land is a fully supported geography in the Tribal platform, not an afterthought. Reservation land, off-reservation trust parcels, restricted-fee and allotted land, Alaska Native Regional and Village Corporation lands, and Native Hawaiian Home Lands are all modeled directly, so a study reflects where activity actually happens instead of being flattened into a surrounding county. If your lands are checkerboarded across county lines, the study still treats them as one geography. Want to walk through your specific land base with the team?",
  },
  {
    id: 'per_cap',
    chip: null,
  ...
  },
  {
    ...
    answer: "We do not pretend input-output models are something they are not. The classic input-output core assumes fixed production coefficients, effectively elastic supply, and linearity, treats people as perfectly rational, and tends to treat geography as a fixed administrative boundary, so on its own it is a short-run, static estimate rather than a forecast. That core is the shared starting point for the whole field, and it is not wrong, it is incomplete. Lumecon keeps its strengths and layers on what economics has learned since: behavioral and causal methods, spatial tools, higher-frequency data, and machine learning, so the estimate better reflects how economies actually work. Where the underlying assumptions still matter for your case, the study surfaces them so a reviewer can weigh them honestly.",
  },
  ...
  /* --- Upsell: free vs paid Cedar (the one new chip) --- */
  {
    ...
    triggers: [
      'free vs paid', 'free version', 'paid cedar', 'real cedar', 'full cedar', 'is the ai cedar included', 'is ai cedar included', 'is cedar free', 'cedar free', 'is the ai cedar free', 'is lumecon free', 'lumecon free', 'free or paid', 'what do i get if i pay', 'what do i unlock', 'unlock cedar', 'upgrade', 'upgrade cedar', 'this cedar vs', 'smarter cedar', 'cedar in the product', 'cedar in the platform', 'what does cedar do in the product', 'difference between this and the paid', 'cedar cost', 'cedar price', 'what does cedar cost', 'whats cedar cost', 'how much is cedar', 'how much does cedar cost', 'price of cedar', 'cost of cedar',
    ],
    answer: "The Cedar you're talking to here is the free, lightweight site assistant: I answer questions about Lumecon, who it's for, the methodology, pricing, and how to reach the team. The full Cedar that comes with a subscription is a different thing entirely: inside the platform it uploads and processes messy data in any format (PDFs, scanned images, spreadsheets, payroll, finance, audit, planning files), structures the inputs against public data sources, surfaces every modeling assumption for your sign-off, and acts as a thought partner on the write-up — helping you brainstorm framing, edit, and reshape the report for each audience. The reports come out branded to your visual identity and you can drop in your own images so the deliverable reads as yours, not ours. Cedar doesn't ghostwrite the report — the best reports come from the context only you have — but it handles the structure, polish, and presentation around what you bring. If you want the version that does the work on your own data, that starts at the Sapling tier. Want me to point you to pricing or set up a demo?",
  ...
  },
  {
    ...
    triggers: [
      'machine learning', 'use machine learning', 'do you use ml', 'modern methods', 'modern econometric', 'econometric methods', 'is this just input output', 'is it just input output', 'more than input output', 'more than io', 'is it just io', 'beyond input output', 'federated learning', 'what methods do you use', 'novel methods', 'do you use ai to model', 'is it just a multiplier model', 'behavioral economics', 'behavioral', 'consumer psychology', 'causal inference', 'causal methods', 'causal', 'randomized control', 'rct', 'spatial methods', 'diff in diff', 'synthetic control', 'modern economics', 'economics has changed', 'how economies actually work',
    ],
    answer: "Yes, and that is a real difference. The input-output core is the shared foundation for the whole field, and we start there on the standard public data so the numbers stay recognizable. On top of it we layer what economics has learned since: behavioral and causal methods, spatial tools, higher-frequency data, and machine learning, with federated learning across studies, all calibrated and benchmarked as we built. The idea is to start where everyone starts, then reflect how economies actually work, instead of assuming perfectly rational actors in clean markets the way a model frozen in 1930s-era input-output does. Where a method or assumption matters for your result, the study shows it.",
  ...
  },
  {
    ...
    triggers: [
      'does cedar write', 'can cedar write', 'write my report', 'write the report for me', 'does it write reports', 'write it for me', 'thought partner', 'brainstorm', 'give me feedback', 'help me write', 'edit my report', 'can it write my report', 'does cedar do the writing', 'will it write the report', 'write the narrative', 'draft the narrative', 'narrative for me', 'write my narrative', 'does cedar write reports', 'help me brainstorm', 'bounce ideas',
    ],
    answer: "Cedar is a thought partner, not a ghostwriter. It helps you brainstorm structure, drafts starting points, edits, and gives you feedback and ideas, and it handles the polish and presentation so the write-up looks sharp for each audience. But the best reports are written with the context only you have: your program, your community, your goals. Cedar makes your work faster and clearer rather than replacing your judgment or inventing the substance.",
  },
  {
    id: 'what_is_rag',
    ...
    answer: "RAG stands for retrieval-augmented generation. In plain terms, instead of answering from memory the way a typical chatbot does, the AI first retrieves the relevant facts from a trusted source (here, your uploaded records and the public data tables) and then answers from those, with a trail back to where each piece came from. That is why Cedar's numbers trace to a real source row rather than a guess. Think of a careful research assistant that looks things up, not one that free-types a plausible answer.",
  },
  {
    id: 'what_is_chatbot',
