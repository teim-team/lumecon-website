...
export const INTENTS: CedarIntent[] = [
  ...
  },
  {
    ...
    answer: "Every study gives you a full report PDF, an editable executive summary, the underlying tables and charts, and a slide-ready deck as starting points you can edit. With Cedar (Sapling tier and above) the report comes out branded to your visual identity (your logo, colors, typography) and you can drop in your own images and photography so the deliverable reads as yours. Cedar works as a thought partner on the write-up: it drafts, edits, takes your feedback, and reshapes the framing for the audience you're talking to (funders see the jobs-and-investment narrative, councils see local benefit, boards see strategic context, public meetings get the plain-language version), while the substance and local context come from you. The numbers are identical across versions; only the framing changes. Who's the audience you need to win over?",
  ...
  },
  {
    ...
    expanded: "More on pricing: Local Sprout is $7.5K, Sapling $15K, Tree $20K. Tribal Sprout is $10K, Sapling $17.5K, Tree $25K. Cedar comes with Sapling and above; on those tiers Cedar produces branded reports built around your visual identity, and you can drop in your own images so the deliverable reads as yours, not ours. Cedar Grove arrives on Tree. There's also a Toolbox add-on at +$15K when you want our team to produce the finished package directly: report, deck, executive summary, source record, assumption ledger, with three rounds of revisions and branded outputs. A separate Consultant plan exists for firms running studies on behalf of two distinct outside clients in a single fiscal year, at $15K flat. Seats scale by tier (one on Sprout, up to five on Sapling, up to ten on Tree). The math under the hood is mainstream economics and the BEA accounts are public; we're charging for the software, not the data.",
  },
  {
    id: 'payment_plans',
  ...
  /* --- Upsell: free vs paid Cedar (the one new chip) --- */
  {
    ...
    answer: "The Cedar you are talking to here is the free, lightweight site assistant: I answer questions about Lumecon, who it is for, the methodology, pricing, and how to reach the team. The full Cedar that comes with a subscription is a different animal: inside the platform it reads your administrative files, harmonizes them against public data, surfaces every modeling assumption, runs the study, and works as a thought partner on the write-up, helping you draft, edit, and reshape it for each audience. The reports come out branded to your visual identity (your logo, colors, typography) and you can drop in your own images so the deliverable reads as yours, not ours. The best reports still come from the context only you have; Cedar handles the structure, polish, and presentation. If you want the version that does the work on your own data, that starts at the Sapling tier. Want me to point you to pricing or set up a demo?",
