...
export const INTENTS: CedarIntent[] = [
  ...
  {
    id: 'pricing',
    followUps: ['toolbox', 'consultant_plan', 'team_access'],
    ...
    answer: "Lumecon runs on a flat annual subscription, not per-study or per-geography. Local starts at $10K a year, Tribal at $12.5K. Each platform has three tiers (Sprout, Sapling, Tree) that top out at $20K for Local and $25K for Tribal, with unlimited studies across reservation, county, state, and national geographies. For comparison, the legacy stack is commonly cited at $50K to $150K per study. The full grid is on the pricing page, no demo call required. Want me to break down what each tier includes?",
    expanded: "More on pricing: Local Sprout is $10K, Sapling $15K, Tree $20K. Tribal Sprout is $12.5K, Sapling $17.5K, Tree $25K. Cedar comes with Sapling and above; Cedar Grove arrives on Tree. There's also a Toolbox add-on at +$15K when you want our team to turn your platform outputs into a finished report, deck, executive summary, and assumption ledger, with three rounds of revisions and branded deliverables. A separate Consultant plan exists for firms running studies on behalf of two distinct outside clients in a single fiscal year, also at $15K flat. Seats scale by tier (one on Sprout, up to five on Sapling, up to ten on Tree) with no per-use metering. The math under the hood is mainstream economics and the BEA accounts are public, so we're not charging for the data. We're charging for the software that makes the analysis usable.",
  },
  {
    id: 'toolbox',
    ...
    triggers: [
      'toolbox', 'tool box', 'add on', 'add-on', 'addon', 'study add on', 'study add-on', 'study package', 'done for you', 'done-for-you', 'done for me', 'write the report', 'write my report', 'write the study', 'finished report', 'finished study', 'finished deliverable', 'branded report', 'branded deliverable', 'press ready', 'press-ready', 'media kit', 'rounds of revision', 'rounds of revisions', 'revisions on', 'help write', 'help me write', 'help with the report', 'help with the deck', 'turn around the report', 'have your team write', 'your team write', 'your team produce',
    ],
    answer: "Toolbox is a +$15K flat-fee add-on that you attach to an active Lumecon subscription. Our team takes the outputs your platform already produces and turns them into a finished economic impact package: a full written report, a presentation deck, an executive summary, a source record and assumption ledger, and one tailored memo or media-ready findings sheet. Three rounds of revisions are included, the deliverables are branded to your visual identity, and the price covers taxes. It is not a standalone product because the heavy lifting happens inside Lumecon; the add-on is the writing, design, and presentation polish on top.",
    expanded: "Why Toolbox is structured this way: a traditional consulting study runs $50K to $150K because the consultant is doing the data work, the modeling, the writing, and the design from scratch every time. With Lumecon, the data structuring, source record, and modeling are already done inside your subscription, so the writing-and-presentation portion is what's left, and that's what Toolbox covers at the flat $15K. The plan recommendation is Sapling or Tree for Toolbox engagements, because Cedar handles the intake and the assumption ledger that the report leans on. Toolbox is not available on the Consultant plan, because that plan is structured around firms producing their own deliverables for their own clients.",
  },
  {
    id: 'consultant_plan',
