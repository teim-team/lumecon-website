...
export const INTENTS: CedarIntent[] = [
     ...
     light tie back to the product at the end. --- */
  {
    ...
    answer:
      'Indian Country is a legal term, not a loose one. Federal law (18 U.S.C. § 1151) defines it as three kinds of land: all land within the limits of any Indian reservation, including rights-of-way; all dependent Indian communities; and all Indian allotments whose Indian titles have not been extinguished. The definition matters because it draws real lines — which government has jurisdiction, which federal rules apply, and where a tribal economy’s study boundary should sit. Lumecon models these geographies directly instead of flattening them into a surrounding county.',
    expanded:
      'A few details people find useful. "Dependent Indian communities" covers lands set aside for a tribe under federal superintendence even without formal reservation status — the New Mexico pueblos are the classic example. Allotments are the parcels left over from the allotment era (ask me about checkerboarding for that story). And reservation boundaries are durable: in McGirt v. Oklahoma (2020) the Supreme Court affirmed that a reservation persists until Congress explicitly disestablishes it. One caution for grant work: Indian Country is a jurisdictional definition, and individual federal programs can use their own land definitions, so check the program statute when funding is on the line.',
  ...
  },
  {
    ...
    answer:
      'Checkerboarding is the patchwork of ownership inside many reservation boundaries: trust parcels, restricted-fee parcels, and fee-simple parcels (often non-Indian owned) sitting side by side like squares on a board. It traces to the allotment era — the General Allotment (Dawes) Act of 1887 broke communally held reservations into individual allotments and opened the "surplus" to sale, and tribal landholdings fell from roughly 138 million acres to about 48 million before the Indian Reorganization Act ended allotment in 1934. The modern effect is jurisdictional and statistical: county lines and Census geographies slice right through a land base. Lumecon’s Tribal platform treats a checkerboarded land base as one geography, so the study follows the tribe’s actual footprint.',
    expanded:
      'The other allotment legacy is fractionation: allotted parcels passed to multiple heirs each generation, so a single parcel can now have dozens or hundreds of co-owners, which complicates leasing and development (federal land buy-back programs have consolidated some of it). For analysis the upshot is simple — parcel-level ownership rarely matches any standard data geography, which is exactly why the platform models the land base directly instead of approximating it with a county.',
  ...
  },
  {
    ...
    answer:
      'Alaska took a different path from the lower 48. The Alaska Native Claims Settlement Act of 1971 settled aboriginal land claims with roughly 44 million acres and $962.5 million, delivered not through reservations but through for-profit corporations owned by Alaska Native shareholders: twelve regional corporations plus roughly 200 village corporations. Alaska also has 229 federally recognized tribes, the most of any state. Because ANCSA lands are mostly fee land, the Supreme Court held in the Venetie decision (1998) that they are generally not Indian Country; Metlakatla’s Annette Islands Reserve is the state’s one reservation. Lumecon models Alaska Native Regional and Village Corporation lands directly, so a study follows the corporation’s actual footprint.',
  ...
  },
  {
    ...
    answer:
      'A federally recognized tribe is one the United States acknowledges as a sovereign tribal nation with a government-to-government relationship — currently 574 of them, listed by the Bureau of Indian Affairs in the Federal Register. Recognition is the gateway status: it carries the federal trust responsibility and eligibility for BIA, IHS, and most tribal set-aside funding. Tribes arrived there by treaty, act of Congress, the administrative acknowledgment process (25 C.F.R. Part 83), or court decision. State-recognized tribes have standing with their state but not the same federal status or funding eligibility.',
    expanded:
      'Why it shows up in economic work: most federal tribal programs, and many philanthropic ones, key eligibility to the Federal Register list, and funders want the applicant’s governmental status stated plainly. An impact study for a federally recognized tribe can also lean on the government-to-government framing — a sovereign reporting the performance of its economy, not a nonprofit asking for charity. That framing, backed by defensible numbers, changes how the room reads the ask.',
  ...
  },
  {
    ...
    answer:
      'Tribal sovereignty is the inherent authority of tribal nations to govern themselves — inherent meaning it predates the U.S. Constitution and was not granted by it. The Supreme Court framed tribes as "domestic dependent nations" in Cherokee Nation v. Georgia (1831): sovereign governments in a direct, government-to-government relationship with the United States, backed by treaties and the federal trust responsibility. In practice sovereignty looks like tribal courts, taxation and regulation, gaming compacts, and control over land and enrollment. Defensible economic data has become part of how it gets exercised: a tribe negotiating a compact or a funding formula is in a stronger position when its own numbers carry the room.',
    expanded:
      'Two distinctions worth keeping straight. Sovereignty versus jurisdiction: sovereignty is the inherent governing authority, while jurisdiction is the parcel-by-parcel question of whose law applies where — which is why Indian Country’s legal definition and checkerboarding matter so much. And political versus racial classification: under Morton v. Mancari (1974), tribal status is a political classification based on citizenship in a sovereign nation, not a racial one, which is why tribal programs stand on distinct legal footing. It is also why data sovereignty is a design requirement in our Tribal platform rather than a feature: a tribe’s data belongs to the tribe.',
  ...
  /* --- Local & regional government civics --- */
  {
    ...
    answer:
      'An Economic Development District (EDD) is a multi-county region designated by the U.S. Economic Development Administration — there are roughly 400 — anchored by a regional planning organization and a CEDS, the Comprehensive Economic Development Strategy the district keeps current. They matter for two reasons: a current CEDS is the ticket to most EDA funding (public works, economic adjustment), and EDDs, councils of governments, and MPOs are usually the bodies actually producing regional economic analysis. If you sit in one of those seats, Lumecon is built for exactly that work — impact studies that drop into a CEDS update or an EDA application without a consulting engagement.',
