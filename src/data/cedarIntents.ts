...
export const INTENTS: CedarIntent[] = [
  ...
  },
  {
    ...
    answer:
      'Today Lumecon covers the United States end to end: county, state, national and reservations, all included in every plan. There is one Lumecon application, and it adapts to the kind of organization you are. If you have a specific country or a cross-border project in mind, tell the team at contact@lumecon.ai and they will say honestly what is possible today.',
  },
