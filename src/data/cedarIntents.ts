...
export const INTENTS: CedarIntent[] = [
  ...
  },
  {
    ...
    answer:
      'Lumecon plans are annual licenses: Sprout is $1,000 a year, Sapling $2,500 and Tree $7,500. At those price points the subscription usually fits a single budget line, which is why there is no separate monthly plan. If you want certainty before spending anything, the free trial lets you create an account, bring your documents and build an analysis end to end at no cost; full results unlock on any paid plan. And if your procurement or fiscal calendar needs a specific billing arrangement, email contact@lumecon.ai and the team will work with your purchasing office.',
    expanded:
