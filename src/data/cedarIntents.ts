...
export const INTENTS: CedarIntent[] = [
  ...
  },
  {
    ...
    triggers: [
      ...
      'contact', 'email', 'email address', 'call', 'call you', 'phone', 'talk to someone', 'speak to someone', 'talk to a human', 'speak to a human', 'talk to a person', 'speak to a person', 'real person', 'real human', 'live person', 'live agent', 'support', 'customer support', 'who do i talk to', 'get a hold of', 'connect with you',
    ],
  ...
  },
  {
    ...
    triggers: [
      'historical', 'longitudinal', 'forward looking', 'forward-looking', 'project forward', 'model forward', 'multi year', 'multi-year', 'multi-year projection', 'multiyear', 'forecast', 'out year', 'out-year', 'biennium', 'biennial', 'plan a budget', 'capital project', 'grant proposal', 'budget proposal', 'over time', 'years out', 'long term impact', 'past impact', 'future impact', 'project into the future',
    ],
  ...
  },
  {
    ...
    triggers: [
      'how long does it take', 'how long does a study take', 'how long does a study', 'how long does the study', 'how long to produce', 'how long is a study', 'study take', 'turnaround', 'turn around time', 'turnaround time', 'turn a study around', 'how fast can you', 'study timeline', 'project timeline', 'lead time', 'how quickly', 'in time for our board', 'before our deadline', 'before grant deadline', 'council vote', 'before our council vote', 'before the vote', 'board meeting', 'by next meeting', 'by our next meeting', 'rush', 'quick turnaround', 'how soon', 'fast turnaround',
    ],
  ...
  },
  {
    ...
    triggers: [
      'cost vs', 'vs hiring a consultant', 'cheaper than a consultant', 'roi', 'roi of', 'return on investment', 'return on lumecon', 'is this worth it', 'is it worth it', 'worth the money', 'why pay for this', 'why subscribe', 'cost of doing nothing', 'budget for impact', 'price compared to', 'savings vs', 'payback', 'payback period', 'cost savings',
    ],
  ...
  },
  {
    ...
    chip: null,
    triggers: [
      'fiscal impact', 'tax revenue', 'net fiscal', 'cost to the city', 'cost to the county', 'revenue vs cost', 'will it pay for itself', 'net new revenue', 'revenue impact', 'fiscal analysis',
    ],
  ...
  },
  {
    ...
    chip: null,
    triggers: [
      'regional purchase coefficient', 'regional purchase coefficients', 'estimate rpc', 'rpc', 'location quotient', 'supply-demand pooling', 'regionalize', 'regionalize national accounts', 'trade leakage', 'inter-regional feedback', 'cross-hauling',
    ],
